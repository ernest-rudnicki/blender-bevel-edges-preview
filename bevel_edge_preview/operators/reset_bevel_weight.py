...
class BEVEL_EDGE_PREVIEW_OT_set_bevel_weight(bpy.types.Operator):
    bl_idname = "bevel_edge_preview.reset_bevel_weight"
    bl_label = "Reset Bevel Weight"
    bl_description = "Resets the bevel weight for the bevel affected edges and sets existing modifiers to use angle method"
    ...
    def execute(self, context):
        ...
        set_bevel_weight_method(obj, "ANGLE")
